<div class="col-sm-4 col-md-4">
 ...
 <ol class="breadcrumb">
           ...
           <li><a href="https://www.tripit.com/"><img src="images/tripit_icon_thumb_flat.png" class="img-responaive" alt="social4 (1K)" /></a>
					 ...
					 <li>
					 <div id="TA_socialButtonIcon198" class="TA_socialButtonIcon"><ul id="1ZQZFtMfz" class="TA_links fMYtY6p6Nv4j"><li id="EXCbzZzbK" class="pU5tSr"><a target="_blank" href="https:/www.tripadvisor.com"><img src="https:/www.tripadvisor.com/img/cdsi/img2/branding/socialWidget/20x20_green-21690-2.png"/></a></li></ul></div><script src="https:/www.jscache.com/wejs?wtype=socialButtonIcon&uniq=198&locationId=54470&color=green&size=sm&lang=en_US&display_version=2"></script>
           </li>
	</ol>	
  ...
  <h5>The slaves that are being traffickited would appreiciate you telling others more then you sending your money to this or any other web site.</h5>

       <img src="images/top-1.jpg" class="img-responsive">

         <h5>Please promote this web site in any legal, moral, and ethical way that you can.</h5>
