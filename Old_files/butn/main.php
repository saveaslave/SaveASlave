...
/* setting whcp url */
$whcpurl = 'rd.webhosting.yahoo.com';
$intl = strtolower(preg_replace("/\d+$/", "", $_ENV['SC']));
if($intl == 'in'){
    $whcpurl = 'rd.p.in.webhosting.yahoo.com';
}
...
<div style="float:right;background-color:#ffffff;padding:10px;font-weight:bold"><a href="http://<?php echo $whcpurl;?>/bounce.php?d=<?=$link;?>" target=new>Control Panel</a></div>
</div>
<?php
