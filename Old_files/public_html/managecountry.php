...
<title>Add/Manage Country</title>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") { 
  ...
  printCountryList('view');

  echo "&nbsp;&nbsp;&nbsp;&nbsp;Manage Country:";

  printCountryList('manage');
...
?>
		...
		<form id="form_1039394" class="appnitro" enctype="multipart/form-data" method="post" enctype="multipart/form-data" action="">
			...
			<h2>Add/Manage Country</h2>

                        <h4>View Country:<?php printCountryList('view'); ?>&nbsp;&nbsp;&nbsp;&nbsp;Manage Country:<?php printCountryList('manage'); ?> </h4>
