...
?>
		...
		<span>
<input id="page_permissions_1" name="page_permissions[]" class="element checkbox" type="checkbox" value="managecountry.php" <?php
if (strpos($row["page_permissions"], "anagecountry.php")) {
  echo " checked";
}
?>>
<label class="choice" for="page_permissions_1">Manage Countries</label>

<input id="page_permissions_2" name="page_permissions[]" class="element checkbox" type="checkbox" value="managelink.php" <?php
if (strpos($row["page_permissions"], "anagelink.php")) {
  echo " checked";
}
?>>
<label class="choice" for="page_permissions_2">Manage Links</label>

<input id="page_permissions_3" name="page_permissions[]" class="element checkbox" type="checkbox" value="managevolunteer.php" <?php
if (strpos($row["page_permissions"], "anagevolunteer.php")) {
  echo " checked";
}?>>
<label class="choice" for="page_permissions_3">Manage Volunteers</label>
